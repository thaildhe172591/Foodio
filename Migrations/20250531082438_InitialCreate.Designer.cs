...
namespace FoodioAPI.Migrations
{
    ...
    [Migration("20250531082438_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodioAPI.Entities.Delivery", b =>
                {
                    b.HasOne("FoodioAPI.Entities.DeliveryStatus", null)
                        .WithMany("Deliveries")
                    ...
                    b.HasOne("FoodioAPI.Entities.DeliveryStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodioAPI.Entities.OrderItemStatusHistory", b =>
                {
                    ...
                    b.HasOne("FoodioAPI.Entities.OrderItemStatus", null)
                        .WithMany("StatusHistories")
                        .HasForeignKey("OrderItemStatusId");

                    b.HasOne("FoodioAPI.Entities.OrderItemStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
